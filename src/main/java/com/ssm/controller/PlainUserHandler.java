 ...
 * @FilePath: \src\main\java\com\ssm\controller\PlainUserHandler.java
...
public class PlainUserHandler {
	...
	public String updateMagess(UserP userP) throws Exception {
		...
		// 使用"redirect"关键字将请求重定向到"/shop-user/user_center_info.html"路径
	...
	public String loginOut(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 使用"redirect"关键字将请求重定向到"/shop-user/login.html"路径
	...
	public String adminDelsUsers(Integer id, Integer shiro_id) throws Exception {
		...
		if (id == null || shiro_id == null) {
			// 如果其中任何一个参数为null，则返回一个JavaScript脚本，该脚本在客户端弹出一个警告框，然后将页面重定向到"/Shop-SSM/admin/index.html"路径
	...
	public String addPlainUsers(UserP userP) throws Exception {
		...
		if (userP.getUsers() == null || userP == null) {
			// 如果"userP"参数为null或者"users"属性为null，则一个JavaScript脚本，该脚本在客户端弹出一个警告框，然后将页面重定向到"/Shop-SSM/shop-user/register.html"路径
			...
			// 如果添加成功，则返回一个JavaScript脚本，该脚本在客户端弹出一个提示框，然后将页面重定向到"/Shop-SSM/shop-user/login.html"路径
			if (falg) {
				return "<script>alert('注册成功');location.href='/Shop-SSM/shop-user/login.html';</script>";
			} else {
				// 如果添加失败，则返回一个JavaScript脚本，该脚本在客户端弹出一个提示框，然后将页面重定向到"/Shop-SSM/shop-user/register.html"路径
